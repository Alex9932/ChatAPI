...
namespace ChatAPI.Migrations
{
    ...
    [Migration("20210918133212_add_auth2")]
    partial class add_auth2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChatAPI.Data.Models.Token", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ChatAPI.Data.Models.Channel", b =>
                {
                    b.HasOne("ChatAPI.Data.Models.Server", "Server")
                        .WithMany("Channels")
            ...
            modelBuilder.Entity("ChatAPI.Data.Models.Token", b =>
                {
                    b.HasOne("ChatAPI.Data.Models.User", "User")
                        .WithMany()
